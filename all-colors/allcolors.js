...
function execAllCorlors (settings) {
  ...
  [].forEach.call(document.querySelectorAll('*'), function (node) {
    ...
    props.forEach(function (prop) {
      ...
      let thisIsABorderProperty = (prop.indexOf('border') !== -1)
      let notBorderZero = thisIsABorderProperty ? window.getComputedStyle(node, null).getPropertyValue(prop.replace('color', 'width')) !== '0px' : true
